...
class _ProfileApiService implements ProfileApiService {
  ...
  Future<DeleteProfileResponseDto> deleteProfile() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeleteProfileResponseDto>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteProfileResponseDto _value;
    try {
      _value = DeleteProfileResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<ChildDto>> getChildrens() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ChildDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ChildDto> addChild(AddChildRequestDto addChildRequest) async {
    ...
    final _options = _setStreamType<ChildDto>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<NotificationDto>> getNotificationsSettings() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<NotificationDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data!
          .map((dynamic i) =>
              NotificationDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<NotificationItemDto> changeNotificationStatus(
    ...
    final _options = _setStreamType<NotificationItemDto>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late NotificationItemDto _value;
    try {
      _value = NotificationItemDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
